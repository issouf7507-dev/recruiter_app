...
export default function MessageriePage() {
  ...
  const getFilteredAndSortedConversations = () => {
    ...
    filtered = filtered.filter(
      (conv) =>
        conv.candidat.name.toLowerCase().includes(searchTerm.toLowerCase()) ||
        conv.candidat.email.toLowerCase().includes(searchTerm.toLowerCase()) ||
    ...
    <div className="flex h-[calc(100vh-4rem)] bg-background w-full">
            ...
            filteredConversations.map((conversation) => (
              ...
              >
                <div className="flex items-start gap-3">
                  <div className="relative">
                    <Avatar>
                      <AvatarImage src={conversation.candidat.avatar || ""} />
                      <AvatarFallback>
                        {conversation.candidat.name
                          .split(" ")
                          .map((n) => n[0])
                          .join("")}
                      </AvatarFallback>
                    </Avatar>
                    {conversation.candidat.isOnline && (
          ...
          <div className="p-4 border-b bg-card">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                <Avatar>
                  <AvatarImage
                    src={currentConversation.candidat.avatar || ""}
                  />
                  <AvatarFallback>
                    {currentConversation.candidat.name
                      .split(" ")
                      .map((n) => n[0])
                      .join("")}
                  </AvatarFallback>
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    ...
                    {currentConversation.jobOffer.company}
                  </p>
                  {currentConversation.candidat.isOnline && (
      ...
      {showConversationInfo && currentConversation && (
        <div className="w-80 border-l bg-card p-4">
          <div className="space-y-4">
            <h3 className="font-semibold">Informations du candidat</h3>

            <div className="space-y-3">
              <div>
                <h4 className="text-sm font-medium">Candidat</h4>
                <p className="text-sm text-muted-foreground">
                  {currentConversation.candidat.name}
                </p>
                <div className="flex items-center gap-2 mt-1">
                  ...
                  <span className="text-xs text-muted-foreground">
                    {currentConversation.candidat.email}
                  </span>
                </div>
              </div>
              ...
              <div>
                ...
                {currentConversation.candidat.lastSeen && (
                  <p className="text-xs text-muted-foreground">
                    Dernière connexion:{" "}
                    {formatTime(currentConversation.candidat.lastSeen)}
                  </p>
                )}
              </div>

              {currentConversation.candidat.phone && (
                <div>
              ...
              {currentConversation.candidat.location && (
                <div>
